...
class Infrared(object):
	...
	def irfollow(self):
		...
		cfg.LEFT_SPEED = 30
		cfg.RIGHT_SPEED = 30
		if (gpio.digital_read(gpio.IRF_L) == 0 and gpio.digital_read(gpio.IRF_R) == 0) or (gpio.digital_read(gpio.IRF_L) == 1 and gpio.digital_read(gpio.IRF_R) == 1 and gpio.digital_read(gpio.IR_M) == 1):
			...
			elif gpio.digital_read(gpio.IRF_L) == 1 and gpio.digital_read(gpio.IRF_R) == 1:
